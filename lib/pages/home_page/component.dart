import '../home_page/row_card/component.dart';
import '../home_page/row_card/models.dart';
import 'package:flutter/material.dart';

import '../expenses/component.dart';

class HomePage extends StatelessWidget {
  HomePage({Key? key}) : super(key: key);

  final List<HomeRowData> homeRows = [
    HomeRowData(Icons.account_balance_wallet, 'Expenses', Colors.red.shade300,
        'expense', const ExpensesPage()),
